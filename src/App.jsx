...
const s = {
  ...
  codeBox: { background: "#f5f5f5", border: "1.5px solid #979595ff", borderRadius: "8px", padding: "8px 16px", fontSize: "26px", fontWeight: "500", letterSpacing: "0.15em", color: "var(--color-text-primary)", display: "inline-block", marginBottom: "16px" },
  muted: { fontSize: "13px", color: "#888" },
  scoreRow: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 12px", background: "#8ecfbbff", border: "1.5px solid #e0e0e0ff", borderRadius: "8px", marginBottom: "6px", fontSize: "14px" },
