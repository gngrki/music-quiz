...
const s = {
  ...
  btnSecondary: { display: "block", width: "100%", padding: "12px", borderRadius: "10px", border: "1.5px solid #d0d0d0", fontSize: "15px", fontWeight: "500", cursor: "pointer", background: "white", color: "var(--color-text-primary)", marginBottom: "8px" },
  ...
  playerRow: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 0", borderBottom: "1.5px solid #e0e0e0", fontSize: "14px" },
  tag: { fontSize: "12px", background: "#E1F5EE", color: "#0F6E56", borderRadius: "20px", padding: "3px 10px" },
  codeBox: { background: "#f5f5f5", border: "1.5px solid #d0d0d0", borderRadius: "8px", padding: "8px 16px", fontSize: "26px", fontWeight: "500", letterSpacing: "0.15em", color: "var(--color-text-primary)", display: "inline-block", marginBottom: "16px" },
  muted: { fontSize: "13px", color: "#888" },
  scoreRow: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 12px", background: "#f9f9f9", border: "1.5px solid #e0e0e0", borderRadius: "8px", marginBottom: "6px", fontSize: "14px" },
  answerBtn: { display: "block", width: "100%", padding: "12px 14px", borderRadius: "10px", marginBottom: "8px", fontSize: "14px", textAlign: "left", cursor: "pointer", border: "1.5px solid #d0d0d0", background: "white", color: "var(--color-text-primary)" },
}
